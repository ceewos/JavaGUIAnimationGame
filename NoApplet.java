...
/**
 * A special panel class to provide Applet-like APIs including 
 * the life-cycle methods. Define a subclass and call the @link{#run()}
 *  method to run it in a JFrame (see the sample code below).
 *
 * <p/>
 * <pre>
